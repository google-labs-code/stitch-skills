...
- A `.stitch/.stitch/DESIGN.md` file (generate one using the `design-md` skill if needed)
- A `.stitch/.stitch/SITE.md` file documenting the site vision and roadmap
...
The `.stitch/.stitch/next-prompt.md` file acts as a relay baton between iterations:
...
[Copy from .stitch/.stitch/DESIGN.md Section 6]
...
- The prompt content must include the design system block from `.stitch/.stitch/DESIGN.md`
...
Parse `.stitch/.stitch/next-prompt.md` to extract:
...
| File | Purpose |
|------|---------|
| `.stitch/.stitch/SITE.md` | Site vision, **Stitch Project ID**, existing pages (sitemap), roadmap |
| `.stitch/.stitch/DESIGN.md` | Required visual style for Stitch prompts |
